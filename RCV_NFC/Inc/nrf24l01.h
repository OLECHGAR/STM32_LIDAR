...
/* Pins configuration */
#define NRF24L01_CE_LOW          HAL_GPIO_WritePin(GPIOA, CE_Pin, GPIO_PIN_RESET)
#define NRF24L01_CE_HIGH         HAL_GPIO_WritePin(GPIOA, CE_Pin, GPIO_PIN_SET)
#define NRF24L01_CSN_LOW         HAL_GPIO_WritePin(GPIOA, CSN_Pin, GPIO_PIN_RESET)
#define NRF24L01_CSN_HIGH        HAL_GPIO_WritePin(GPIOA, CSN_Pin, GPIO_PIN_SET)
